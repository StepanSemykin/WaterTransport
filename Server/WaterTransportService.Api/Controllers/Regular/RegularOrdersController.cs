...
public class RegularOrdersController(IRegularOrderService service) : ControllerBase
{
    ...
    [HttpGet("{id:guid}")]
    public async Task<ActionResult<RegularOrderDto>> GetById(Guid id, CancellationToken ct)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<RegularOrderDto>> Create([FromBody] CreateRegularOrderDto dto, CancellationToken ct)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<ActionResult<RegularOrderDto>> Update(Guid id, [FromBody] UpdateRegularOrderDto dto, CancellationToken ct)
    {
