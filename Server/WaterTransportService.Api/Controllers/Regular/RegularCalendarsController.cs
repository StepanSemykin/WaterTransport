...
/// <summary>
/// Контроллер для управления календарями регулярных рейсов.
/// </summary>
[ApiController]
...
public class RegularCalendarsController(IRegularCalendarService service) : ControllerBase
{
    ...
    /// <summary>
    /// Получить список всех календарей регулярных рейсов с пагинацией.
    /// </summary>
    ...
    /// <summary>
    /// Получить календарь регулярных рейсов по идентификатору.
    /// </summary>
    ...
    [HttpGet("{id:guid}")]
    [ProducesResponseType(typeof(RegularCalendarDto), StatusCodes.Status200OK)]
    ...
    [HttpPost]
    [ProducesResponseType(typeof(RegularCalendarDto), StatusCodes.Status201Created)]
    ...
    /// <summary>
    /// Обновить календарь регулярных рейсов.
    /// </summary>
    /// <param name="id">Уникальный идентификатор календаря.</param>
