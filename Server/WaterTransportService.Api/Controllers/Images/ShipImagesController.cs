...
public class ShipImagesController(IImageService<ShipImageDto, CreateShipImageDto, UpdateShipImageDto> service) : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<ShipImageDto>> Create([FromBody] CreateShipImageDto dto)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<ActionResult<ShipImageDto>> Update(Guid id, [FromBody] UpdateShipImageDto dto)
    {
